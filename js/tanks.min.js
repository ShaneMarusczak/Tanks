...
W);a.removeEventListener("mouselout",X)}),n=!0,w=!1,N(v),fa(),B?(G(m),window.focus(),Y(),Z()):B||(document.getElementById("wallMessage").classList.add("hidden"),document.getElementById("noPathMessage").classList.remove("hidden")))}function fa(){for(let a=0;a<p;a++)for(let b=0;b<q;b++)l(a,b).classList.remove("cell_hover")}function ha(a){const b=[];"N"===k?(b.push(a.offsetLeft-3.5+a.offsetWidth/2),b.push(a.offsetTop-15)):"S"===k?(b.push(a.offsetLeft+a.offsetWidth/2),b.push(a.offsetTop)):"E"===k?(b.push(a.offsetLeft+
a.offsetWidth),b.push(a.offsetTop)):"W"===k?(b.push(a.offsetLeft),b.push(a.offsetTop)):"NW"===k?(b.push(a.offsetLeft),b.push(a.offsetTop-a.offsetHeight/2)):"NE"===k?(b.push(a.offsetLeft+a.offsetWidth),b.push(a.offsetTop-a.offsetHeight/2)):"SW"===k?(b.push(a.offsetLeft),b.push(a.offsetTop+a.offsetHeight/2)):"SE"===k&&(b.push(a.offsetLeft+a.offsetWidth),b.push(a.offsetTop+a.offsetHeight/2));return b}function aa(){const a=document.createElement("div");a.classList.add("laser");const [b,c]=ha(L(v));a.style.left=
b+"px";a.style.top=c+"px";const d=20*ia[k],e=20*ja[k];a.style.transform="rotate("+ka[k]+"deg)";C.appendChild(a);for(let g=0;30>g;g++)F(25*g).then(()=>{a.style.top=c-e*g+"px";a.style.left=b-d*g+"px";H(a,C)||a.remove();H(a,L(m))&&(document.getElementsByClassName("start")[0].classList.remove("start"),M("You shot the enemy tank!"));Array.from(document.getElementsByClassName("wall")).forEach(x=>{H(a,x)&&a.remove()});Array.from(document.getElementsByClassName("edge")).forEach(x=>{H(a,x)&&a.remove()})});
F(600).then(()=>a.remove())}async function Z(){for(;!A&&!y;){var a=z.dequeue();if("undefined"!==typeof a&&null!==a){var b=void 0;a=a.description;for(let c of v.neighbors)if(c.direction===a){b=h[c.x][c.y];break}"undefined"===typeof b||null===b||b.wall||(b.start_cell?M("You ran into the enemy tank"):(S(),b.end_cell=!0,L(b).classList.add("end"),v=b,N(v),B&&G(m),k=a))}b=D.dequeue();"undefined"!==typeof b&&null!==b&&f[" "]&&aa();b=O();for(let c of b){if(b="move"===c.type&&I())a:{b=c.description;for(let d of v.neighbors)if(d.direction===
b){b=h[d.x][d.y];if("undefined"===typeof b||null===b)break;if(b.wall)break;b=!0;break a}b=!1}b&&z.enqueue(c);"fire"===c.type&&D.enqueue(c)}await F(100)}}async function Y(){for(;!A&&!y;)la(),await F(ba)}function la(){ba=Array.from(document.getElementById("difficulty").options).find(a=>a.selected).value;ea()}function G(a){a.path=!0;0!==a.distance&&(a.start_cell||(l(a.x,a.y).classList.remove("visited"),l(a.x,a.y).classList.add("path")),G(a.getLowestDistanceNeighbor()))}function N(a){const b=new Queue;
a.visited=!0;for(b.enqueue(a);!b.isEmpty();){a=b.dequeue();if(a.start_cell)break;for(let c of a.neighbors.reverse()){let d=h[c.x][c.y];"NE"===c.direction&&J("N","E",a,"NE")?a.neighbors.splice(a.neighbors.indexOf(c),1):"SE"===c.direction&&J("S","E",a,"SE")?a.neighbors.splice(a.neighbors.indexOf(c),1):"SW"===c.direction&&J("S","W",a,"SW")?a.neighbors.splice(a.neighbors.indexOf(c),1):"NW"===c.direction&&J("N","W",a,"NW")?a.neighbors.splice(a.neighbors.indexOf(c),1):(d.start_cell&&(B=!0),d.distance>a.distance+
c.connection_cost&&d.visited&&(d.distance=a.distance+c.connection_cost),d.visited||d.wall||(d.visited=!0,d.distance=a.distance+c.connection_cost,l(d.x,d.y),d.wall||b.enqueue(d)))}}}function J(a,b,c,d){let e=null,g=null,x=null;for(let t of c.neighbors)t.direction===a&&(e=h[t.x][t.y]),t.direction===b&&(g=h[t.x][t.y]),t.direction===d&&(x=h[t.x][t.y]);return null===e||null===g||null===x?!1:e.wall&&g.wall?!x.wall:!1}function ma(a){n||ca||(a.target.classList.add("hidden"),r.disabled=!1,r.classList.remove("hidden"),
q=p=a=Array.from(document.getElementById("mapSize").options).find(b=>b.selected).value,document.getElementById("mapSizeDropdown").classList.add("hidden"),na(),ca=!0,document.getElementById("startMessage").classList.remove("hidden"),r.scrollIntoView({behavior:"smooth"}))}function P(a){R=void 0===a.buttons?1===a.which:1===a.buttons}function na(){for(let a=0;a<p;a++){h.push([]);const b=document.createElement("div");b.id="col-"+a;b.classList.add("col");b.draggable=!1;b.ondragstart=function(){return!1};
